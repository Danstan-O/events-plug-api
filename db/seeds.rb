...
events2 = Event.create!(name: "swimming competition", price: 500, address: "3422-00100", location: "kasarani stadium",
...
events3 = Event.create!(name: "Ruger concert", price: 4000, address: "kimathi street", location: "kicc",
...
events4 = Event.create!(name: "horse riding", price: 1500, price: 123, address: "ngong race course", location: "ngong", category: "Hiking and Adventure",
...
events5 = Event.create!(name: "solFest", price: 4000, address: "1234-kimathi street", location: "kicc",
...
events6 = Event.create!(name: "ngong hill hiking", price: 2500, address: "6722-00100", location: "ngong hills",
...
events7 = Event.create!(name: "mt. longonot hiking", price: 3300, address: "8772-kijabe street", location: "longonot",
...
events8 = Event.create!(name: "hackathon", price: 0, address: "1254-ngong-lane", location: "moringa school", category: "IT and Technology",
...
events10 = Event.create!(name: "archery", price: 800, address: "24552-naivasha", location: "gilgil", category: "Hiking and Adventure",
