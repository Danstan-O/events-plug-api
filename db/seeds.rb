...
events2 = Event.create!(name: "musyoka was here", price: 123,
...
events3 = Event.create!(name: "solFest", address: "1234-kimathi street", location: "kicc",
...
events4 = Event.create!(name: "Sauti africa", address: "199-omwogo street", location: "kare4",
