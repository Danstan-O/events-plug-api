...
# connecting user table and events tables

user_events1 = UserEvent.create!(user_id: user1.id, event_id: events1.id)
user_events2 = UserEvent.create!(user_id: user2.id, event_id: events2.id)
user_events3 = UserEvent.create!(user_id: user3.id, event_id: events3.id)
user_events4 = UserEvent.create!(user_id: user4.id, event_id: events4.id)
user_events5 = UserEvent.create!(user_id: user1.id, event_id: events5.id)
user_events6 = UserEvent.create!(user_id: user2.id, event_id: events6.id)
user_events7 = UserEvent.create!(user_id: user3.id, event_id: events7.id)
user_events8 = UserEvent.create!(user_id: user4.id, event_id: events8.id)
user_events9 = UserEvent.create!(user_id: user1.id, event_id: events9.id)
user_events10 = UserEvent.create!(user_id: user2.id, event_id: events10.id)
