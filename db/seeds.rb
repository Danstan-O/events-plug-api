...
events2 = Event.create!(name: "swimming competition", address: "3422-00100", location: "kasarani stadium",
    category: "sports", description: "this will be an east africa annual swimming competition that will be held at kasarani stadium ", like: :faulse,
...
events5 = Event.create!(name: "solFest", address: "1234-kimathi street", location: "kicc",
    ...
    like: :faulse,image: "https://res.cloudinary.com/dghmulj4i/image/upload/v1673433066/event-plug/sautisole-music-consert_hv0ua2.png",
...
events7 = Event.create!(name: "mt. longonot hiking", address: "8772-kijabe street", location: "longonot",
        category: "hiking and adventure", description: "we will be doing a group hiking in the tallest mountain in the kenyan rift valley", like: :faulse,
...
events10 = Event.create!(name: "archery", address: "24552-naivasha", location: "gilgil", category: "hiking and adventure", 
    description: "this event is for the lovers of archery and those who would like to learn how to archer. come one, come all", like: :faulse,
